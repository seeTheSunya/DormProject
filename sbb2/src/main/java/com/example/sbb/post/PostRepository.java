...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    // ★ 추가: 학교별 게시글 조회
    List<Post> findByCategoryAndMember_School(String category, String school);
    List<Post> findByCategoryAndMember_SchoolAndTitleContaining(String category, String school, String keyword);
    List<Post> findByMember_School(String school);
}