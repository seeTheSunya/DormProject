...
public class UserService {
    ...
    public Member create(String username, String password, String email) {
        ...
        member.setSchool(extractSchoolFromEmail(email)); // 이메일에서 학교 추출
    ...
    // 이메일 도메인에서 학교 코드 추출
    private String extractSchoolFromEmail(String email) {
        ...
        // 충북대학교
        if (domain.contains("chungbuk.ac.kr")) {
            return "chungbuk";
        }
        // 연세대학교
        if (domain.contains("yonsei.ac.kr")) {
            return "yonsei";
        }
        // 고려대학교
        if (domain.contains("korea.ac.kr")) {
            return "korea";
        }
        // 서울대학교
        if (domain.contains("snu.ac.kr")) {
            return "snu";
        }
        // 다른 학교 추가 가능
